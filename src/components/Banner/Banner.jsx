    ...
    <div className='container' >
      ...
      className='grid grid-cols-1 md:grid-cols-3 gap-6 items-center text-white rounded-3xl '>
        ...
        <div className='p-6 sm:p-8'>
          <p data-aos="slide-right" className='text-3xl mb-4'>{data.discount}</p>
          <h1 data-aos="zoom-out" className='uppercase text-4x lg:text-7xl font-bold'>{data.title}</h1>
        ...
        <div data-aos="zoom-in" className='h-full flex items-center'>
          <img src={data.image} alt="" className='scale-100 w-[250px] md:w-[340px] mx-auto  object-cover'/>
        </div>
        {/*third col */}
