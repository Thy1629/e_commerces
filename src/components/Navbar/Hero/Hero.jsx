...
import Image1 from "../../../assets/Asset/Image1.png";
import Image2 from "../../../assets/Asset/Image2.png";
import Image3 from "../../../assets/Asset/Image3.png";
...
const Hero = ({handleRegisterPopup}) => {
    const settings = {
        dots: false,
        infinite: false,
        speed: 800,
    ...
    return (
        <div className='container'>
            <div className='overflow-hidden rounded-3xl min-h-[550px] sm:min-h-[650px] hero-bg-color flex justify-center items-center mt-8'>
